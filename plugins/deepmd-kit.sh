#!/bin/bash
# ============================================================
# plugins/deepmd-kit.sh — DeePMD-kit 插件 (Python 包)
# ============================================================

# ---------- 插件默认值 ----------
SOFTWARE_NAME="deepmd-kit"
REPO="https://github.com/deepmodeling/deepmd-kit.git"
BRANCH="master"
MODULES=""
BUILD_TYPE="python"
BASE_ENV="/opt/envs/deepmd3.1.2.env"
PIP_INSTALL_ARGS=""
PYPI_MODE=false
PYPI_PACKAGE="deepmd-kit"

# ---------- 插件帮助 ----------
plugin_usage() {
    cat <<'EOF'
DeePMD-kit 安装选项:
  --base-env PATH          base conda env 脚本路径，默认: /opt/envs/deepmd3.1.2.env
